          ...
          children: [
            ...
            Row(
              children: [
                Expanded(
                  child: TextField(
                    controller: controller.quantityController, // <-- ADDED THIS
                    decoration: const InputDecoration(
                      labelText: 'Quantity',
                      border: OutlineInputBorder(),
                    ),
            ...
            Obx(() {
              ...
              if (!isBird) return const SizedBox.shrink();
              ...
              return Column(
                children: [
                      ...
                      Expanded(
                        child: TextField(
                          ...
                          decoration: InputDecoration(
                            ...
                            filled:
                                controller.weight2.value >
                                0, // Visual hint that it's inactive
                  ...
                  DropdownButtonFormField<int>(
                    ...
                    onChanged: (val) => controller.selectedTraderId.value = val,
                  ),
                ],
              );
            }),
